...
static const QString &ServiceManagerName =
    QStringLiteral("org.deepin.service.manager");
static const QString &ServiceManagerPath =
    QStringLiteral("/manager");
static const QString &ServiceManagerPrivatePath =
    QStringLiteral("/manager/private");

static const QString &PluginManagerPath =
    QStringLiteral("/manager/Plugin");

static const QMap<QDBusConnection::BusType, QString> typeMap{
    {QDBusConnection::SystemBus, "system"},
    {QDBusConnection::SessionBus, "user"}};
